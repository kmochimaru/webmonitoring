...
<html>
    ...
    <body style="background-color: #FFFFFF;" onload="myLoading()">
        <div class="container" ng-app="stateApp" ng-controller="mainController">
            ...
            <center><h1>เช็คชื่อการเข้าร่วมกิจกรรม&nbsp;<%= new String(request.getParameter("activityName").getBytes("iso-8859-1"), "UTF-8") %></h1></center>
                                ...
                                <tbody>
                                    <tr ng-repeat="(key, std) in listStudent">
                                        ...
                                        <td><center>
                                                ...
                                                <input type="radio" id="radio2{{std.studentId}}" name="group{{key+1}}" value="absent"
                                                        ng-model="state"
                                                        ng-click="toggleSelection(std.studentId, state)" 
